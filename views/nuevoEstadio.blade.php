...
<h2>Alta Nuevo Estadio</h2>
<form action="{{ route('crearEstadio') }}" method="POST">
    @csrf
    <fieldset style="width:40%;">
        <legend>Nuevo Estadio</legend>
            Nombre: <input type="text" name="nombre_Estadio"><br><br>
        ...
        <br>
            Ciudad: <input type="text" name="ciudad"><br><br>
                ...
                @enderror
        <br>
            Aforo: <input type="number" name="aforo" ><br><br>
                @error('aforo')
                    <div style='color:red;'>
                        {{ $message }}
                    </div>
        ...
        <div class="button-container">
            <input type="submit" name='Insertar' value='Crear Estadio'>
        </div>
        </fieldset>
    </form>
        @if (session('mensaje'))
